  ...
  return (
    ...
    <div className='sidebar__container'>
        <div className="nav-list__container">
            ...
            <div><a className='sidebar__text' href='/about' ><BsKanban/> About </a></div>
            ...
            <div style={{cursor:"pointer"}} onClick={settingsModal}><a className='sidebar__text' href='/' ><VscSettingsGear onClick={settingsModal}/> Settings </a></div>
            <div><a className='sidebar__text' href='/' ><BiLogOut /> Sign out </a></div>
            </div>
        </div>
    </div>
    </div>
