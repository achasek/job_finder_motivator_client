...
export default function CalendarGfg() {
  ...
  return (
    <div class="calendarWrapper"style={{position:"absolute", left:"50%", display:"flex", justifyContent:"center", alignItems:"center", top:"55%", backgroundColor:"#F2F2F2", height:"40%", width:"20vw",
